                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body px-lg-5 pt-0">
                            ...
                            <!-- Form -->
                            <form class="text-center" style="color: #757575;" action="app/action_actualizar.php" method="POST" role="form">
                                ...
                                <br>
                                <!-- Send button -->
                                <button name="cliente_id" value="<?=$cliente_id?>" class="btn aqua-gradient btn-block" style="max-width:160px; margin: 0 auto;"
